      ...
      .then((data) => {
        if (data.cod === "404") {
          ...
          document.querySelector(
            "#humidity"
          ).innerHTML = `${weather_info.humidity}%`;
          document.querySelector(
            "#temp"
          ).innerHTML = `${weather_info.temperature}°`;
          document.querySelector(
            "#pressure"
          ).innerHTML = `${weather_info.pressure} Pa`;
          ...
          var map = new mapboxgl.Map({
            ...
            style: "mapbox://styles/ianmugenya/ckkl5zmxu326p17t6etkfouxn", // style URL
